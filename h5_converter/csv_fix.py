...
This is to merge the two csv together.
"""

# changed by jizong
train_set = True  # Denotes whether we're building new .csv for train or test files.
images_csv = '/media/jizong/Jizong/PROSTATEx/ProstateX-TrainingLesionInformationv2/ProstateX-Images-Train.csv'
findings_csv = '/media/jizong/Jizong/PROSTATEx/ProstateX-TrainingLesionInformationv2/ProstateX-Findings-Train.csv'

# train_set = False # Denotes whether we're building new .csv for train or test files.
# images_csv = '/media/jizong/Jizong/PROSTATEx/ProstateX-TestLesionInformation/ProstateX-Images-Test.csv'
# findings_csv = '/media/jizong/Jizong/PROSTATEx/ProstateX-TestLesionInformation/ProstateX-Findings-Test.csv'
...
with open(images_csv, 'r')as images_train:
    with open(findings_csv, 'r') as findings_train:
        ...
        column_names = reader_images.__next__()
        column_names.append('Zone')
        column_names.append('ClinSig')
        reader_findings.__next__()
        all_findings_rows = []
